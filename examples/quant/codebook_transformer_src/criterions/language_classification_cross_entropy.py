...
class LanguageClassificationCrossEntropyCriterion(
    ...
    def forward(self, model, sample, reduce=True, classification_step=False, language_classifier_one_vs_rest=0,
        ...
        if classification_step:
            ...
            classifier_loss, classifier_nll_loss, n_correct, total, stats_per_lang = self.compute_encoder_classification_loss(
                sample["net_input"],
                net_output,
            ...
            classifier_loss, classifier_nll_loss, _, _, _ = self.compute_encoder_classification_loss(
                sample["net_input"],
                net_output,
