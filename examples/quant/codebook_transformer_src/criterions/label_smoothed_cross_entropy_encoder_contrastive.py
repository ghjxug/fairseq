...
class EncoderSimilarityLabelSmoothedCrossEntropyCriterion(
    ...
    def forward(self, model, sample, reduce=True):
        ...
        prev_input_tokens[:, 0] = 2  # EOS TODO: get EOS idx from model
        ...
        for i, s in enumerate(prev_input_tokens):
            if src_lengths[i] != max_len:
                ...
                prev_input_tokens[i][src_lengths[i]] = 1  # PAD # TODO: get PAD idx from model
    ...
    def add_args(parser):
        ...
        # TODO: assert language token setup: src prepended to src; tgt prepended tgt
